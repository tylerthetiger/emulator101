...
#include <stdlib.h>
#include <stdint.h>
//buffer is the raw data, pc is the offset into that buffer that we are currently at
//return value is the total bytes disassembled
int Disassemble8080Op(unsigned char *codebuffer, int pc)
{
 ...
 int main (int argc, char**argv)    
   {    
    ...
    int pc = 0;    
    int retVal = 0;
    while (pc < fsize && retVal!=-1)    
    {    
        retVal = Disassemble8080Op(buffer, pc);  
        pc+=retVal;  
    }    
    return 0;    
   }    
